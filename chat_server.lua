...
function clear(player)
  triggerClientEvent(player, "onchatClear", player)
end

function show(player, bool)
  triggerClientEvent(player, "onchatShow", player, bool)
end

function output(player, message)
  triggerClientEvent(player, "onchatOutput", player, message)
end
...
addEventHandler("onchatMessage", resourceRoot, onChatMessage)
